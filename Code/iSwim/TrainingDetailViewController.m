...
- (void)viewDidLoad {
    ...
    [self loadEventIdData:@"http://192.168.1.142:8080/swimming_app/app/client/events/info/enevtId.do"];
    ...
    [HttpJsonManager getWithParameters:parameters
                     ...
                     completionHandler:^(BOOL sucess, id content)
     {
         if (sucess) {
            ...
            NSLog(@"%@",content);
             [self loadData:@"http://192.168.1.142:8080/swimming_app/app/client/events/split/chart.do"];
